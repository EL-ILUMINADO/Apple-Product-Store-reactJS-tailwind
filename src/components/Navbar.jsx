...
const Navbar = ({ activePage, handleNavClick, isNavOpen, toggleNav }) => {
  return (
    <>
      <div
        className={`2xl:w-80 xl:w-52 h-full w-44 bg-[#f8f8f8] flex flex-col justify-between pt-5 pl-6 pb-14 md:pb-0 absolute md:relative z-10 transition-transform duration-300 ${
